...
#This file is the main file that runs code such as "wave code"
...
def generate_tone(wavefn=trianglewave, freq=440, duration=1, amp=1):
...
def volumefilter(samples, factor=.75):
    ...
    """
    samples = [sample*factor for sample in samples]
...
def decayfilter(samples, decaytime=.5, SAMPLERATE=44100):
    ...
    """
    factor = 0.5 ** (1/SAMPLERATE*decaytime)
